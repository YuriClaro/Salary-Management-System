...
VALUES
    ('216bca7a-d610-4a4f-9a6b-089f7601fc90', 'system', 'system', 'Alice Silva', 'alice.silva@example.com', 'ADMINISTRATOR', 0),
    ('a1c109b4-a76b-43dc-ac97-9df45370682a', 'system', 'system', 'Bruno Oliveira', 'bruno.oliveira@example.com', 'OPERATIONAL', 0),
